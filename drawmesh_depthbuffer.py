...
shader = read_shader("shaders/mesh_rasterization_depth.hlsl")
clear_shader = read_shader("shaders/simple_clear_screen.hlsl")
clear_depth_buffer_shader = read_shader("shaders/clear_depth_buffer.hlsl")
early_depth_pass_shader = read_shader("shaders/early_depth_pass.hlsl")
...
compute = Compute(shader, uav=[target, stats_buffer], srv=[vertex_buffer, index_buffer, color_buffer,depth_buffer], cbv=[configBuffer])
